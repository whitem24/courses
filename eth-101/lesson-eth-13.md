...
1. Create a smart contract. You're welcome to use [OpenZepplin](https://docs.openzeppelin.com/contracts/4.x/)'s libraries.
2. Getters that read from your contract and setters that write to your smart contract.
